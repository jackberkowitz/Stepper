...
{
	//Set Up
	DDRD = 0b11110000; //data register, pins PD4-PD7 set as output stepper motor control
	DDRC = 0b00000000; //data register, pin PC0 input for switch
	int flag = 0;

	if(flag==0)
	{
	while(PINC & 0b00000001) {} //will run forever when PC0 is high (switch not pressed)
	flag++;
	}
